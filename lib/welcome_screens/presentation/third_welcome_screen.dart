...
import 'package:azhlha/welcome_screens/presentation/fourth_welcome_screen.dart';
    ...
    return Scaffold(
        ...
        Column(
          ...
          children: [
            ...
            Text("Select your favourite products",style: TextStyle(color: Colors.black87,fontSize: 22.sp,),),
            SizedBox(height: 10.h,),
            Text("حدد قائمة منتجاتك المفضلة",style: TextStyle(color: Colors.black87,fontSize: 22.sp,),),
            ...
            InkWell(
              ...
              onTap: (){
                Navigator.pushReplacement(context, MaterialPageRoute(
                    builder: (BuildContext context) => FourthWelcomeScreen()));
              },
            )
          ],)
    );
